...

{
    ...
    fields: [//mandatory
        ...
        { scheduled: { address: 'departure', inputtype: 't', timestampformat: '' ,sort:true} },
        { estimated: { address: 'departure', inputtype: 't', timestampformat: '' } },
        { actual: { address: 'departure', inputtype: 't', timestampformat: '' } },
        { delay: { address: 'departure' } },
