{
    ...
    config: {
        ...
        urlparams: { apikey: 'enter your api key here', airportcode: 'LHR' }, //parameters that are embedded into the baseURL, such as an api key and the airport of interest (Heathrow)
